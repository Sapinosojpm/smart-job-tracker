...
const TOUR_STEPS: Step[] = [
  {
    ...
    description: "This is your intelligent dashboard for searching and managing remote jobs. Let's take a quick 1-minute tour of how it works.",
    selector: "",
    position: 'center',
  },
  {
    title: "🤖 AI Web Crawler",
    description: "Click 'Start AI Scraper' to fetch new job listings from the web. A popup will let you customize your target job title and select which platforms (We Work Remotely, OnlineJobs, etc.) to scan.",
    selector: "#tour-search-btn-wrapper",
    position: 'bottom',
  },
  {
    title: "⚡ Scrapes Left Today",
    description: "See your remaining scraper quota. Free tier accounts get 50 scrapes daily, while Elite users get unlimited crawler scans.",
    selector: "#tour-quota-badge",
    position: 'bottom',
  },
  {
    title: "🎯 Filter Board Tabs",
    description: "Quickly view 'ALL' loaded jobs, only 'NEW' listings you haven't opened yet, or jobs you have marked as 'APPLIED'.",
    selector: "#tour-filters",
    position: 'top',
  },
  {
    title: "🔍 Local Board Filter",
    description: "Looking for something specific already on your board? Type here to instantly filter loaded jobs on your screen by title, company, or tech keywords. This is instant and does not count as a web scrape.",
    selector: "#tour-search-bar",
    position: 'bottom',
  },
  {
    title: "💼 Track your Jobs",
    description: "Click the circle checkbox on any job card to mark it as 'Applied' to track your application status, or click 'Apply' to visit the direct job link.",
    selector: "#tour-job-card",
    position: 'top',
  },
  {
    title: "⚙️ Board Options",
    description: "Here you can repeat the guide tour, download your job board as a CSV file, or clear unapplied jobs to start fresh.",
