...
import { Lock, Loader2, ChevronRight, CheckCircle2, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="relative w-full max-w-[440px] bg-white rounded-[32px] p-10 md:p-12 shadow-2xl border border-slate-100/80 z-10 animate-fade-up">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            {[
              { label: 'New Password', id: 'password', value: password, set: setPassword, placeholder: '••••••••' },
              { label: 'Confirm Password', id: 'confirm', value: confirmPassword, set: setConfirmPassword, placeholder: '••••••••' },
            ].map(f => (
              <div key={f.id}>
